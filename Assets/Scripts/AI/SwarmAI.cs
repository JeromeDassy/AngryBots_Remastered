...
public class SwarmAI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < buzzers.Length; i++)
        {
            ...
            buzzer.electricBall = buzzer.transform.GetComponentInChildren<ParticleEmitter>();
    ...
    private IEnumerator DoElectricArc(BuzzerData buzz)
    {
        ...
        while (Time.time < stopTime)
        {
            ...
            //buzz.electricArc.sharedMaterial.mainTextureOffset.x = Random.value;//TODO to fix
            yield return null;
        }
