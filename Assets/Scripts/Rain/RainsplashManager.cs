...
public class RainsplashManager : MonoBehaviour
{
    ...
    private Mesh CreateMesh()
    {
        ...
        Vector3 cameraRight = transform.right * Random.Range(0.1f, 2.0f) + transform.forward * Random.Range(0.1f, 2.0f);
        ...
        for (int i = 0; i < particleNum; i++)
        {
            ...
            verts[i4 + 0] = position - cameraRight * widthWithRandom;
            verts[i4 + 1] = position + cameraRight * widthWithRandom;
