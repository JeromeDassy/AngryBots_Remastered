...
public class PlayerMoveController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Set up the movement plane of the player
    ...
    private void Update()
    {
        ...
        // Set up the movement plane of the character, so screen positions
        ...
        axisX = Input.GetAxis("LookHorizontal");
        axisY = Input.GetAxis("LookVertical");
    ...
    private void HandleCursorAlignment(Vector3 cursorWorldPosition)
    {
        ...
        // Make thecursor smaller when close to character
        ...
        cursorObject.localScale = Vector3.one * Mathf.Lerp(compensatedScale, 1f, cursorSmallerWithDistance) * cursorScaleMultiplier;
