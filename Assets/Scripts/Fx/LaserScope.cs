...
public class LaserScope : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (hitInfo.transform)
        {
            ...
            GetComponent<Renderer>().material.mainTextureScale = new Vector2(0.1f * hitInfo.distance, 1.0f);
        ...
        else
        {
            ...
            GetComponent<Renderer>().material.mainTextureScale = new Vector2(0.1f * maxDist, 1.0f);
